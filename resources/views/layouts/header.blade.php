<div class="header-dashboard">
    <div class="wrap">
        <div class="header-left">
            <a href="index.html">
                <img class="" id="logo_header_mobile" alt="" src="{{ asset('files/images/logo/logo.png') }}" data-light="images/logo/logo.png" data-dark="images/logo/logo-dark.png" data-width="154px" data-height="52px" data-retina="images/logo/logo@2x.png">
            </a>
                            ...
                            <ul>
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="{{ asset('files/images/products/17.png') }}" alt="">
                                    </div>
                                ...
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="{{ asset('files/images/products/18.png') }}" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14">
                                    <div class="image no-bg">
                                        <img src="{{ asset('files/images/products/19.png') }}" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                    ...
                    <ul class="">
                        ...
                        <li>
                            <ul>
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="{{ asset('files/images/products/20.png') }}" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="{{ asset('files/images/products/21.png') }}" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14 mb-10">
                                    <div class="image no-bg">
                                        <img src="{{ asset('files/images/products/22.png') }}" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                ...
                                <li class="product-item gap14">
                                    <div class="image no-bg">
                                        <img src="{{ asset('files/images/products/23.png') }}" alt="">
                                    </div>
                                    <div class="flex items-center justify-between gap20 flex-grow">
                                        <div class="name">
                                            <a href="product-list.html" class="body-text">Mega Pumpkin Bone</a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1" >
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="{{ asset('files/images/avatar/user-11.png') }}" alt="">
                                </div>
                                <div class="flex-grow">
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="{{ asset('files/images/avatar/user-12.png') }}" alt="">
                                </div>
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                <div class="image">
                                    <img src="{{ asset('files/images/avatar/user-13.png') }}" alt="">
                                </div>
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4" >
                        ...
                        <li>
                            <ul class="list-apps">
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-1.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-2.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-3.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-4.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-5.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-6.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-7.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-8.png') }}" alt="">
                                    </div>
                                    <a href="#">
                                ...
                                <li class="item">
                                    <div class="image">
                                        <img src="{{ asset('files/images/apps/item-9.png') }}" alt="">
                                    </div>
                                    <a href="#">
                ...
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="header-user wg-user">
                            <span class="image">
                                <img src="{{ asset('files/images/avatar/user-1.png') }}" alt="">
                            </span>
